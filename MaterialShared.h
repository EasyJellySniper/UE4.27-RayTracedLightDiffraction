...
public:
	...
	/* SQUALL MOD - Add custom usages */
	virtual bool IsUsedWithLightDiffraction() const { return false; }
	/* END MOD */
...
public:
	...
	/* SQUALL MOD - Add custom usages */
	ENGINE_API virtual bool IsUsedWithLightDiffraction() const override;
	/* END MOD */
...
struct FMaterialShaderParameters
{
	...
	union
	{
		...
		struct
		{
			...
			/* SQUALL MOD - Add custom usage flags */
			uint64 bIsUsedWithLightDiffraction : 1;
			/* END MOD */
		};
	};
	...
	FMaterialShaderParameters(const FMaterial* InMaterial)
	{
		...
		/* SQUALL MOD - Add custom usage flags */
		bIsUsedWithLightDiffraction = InMaterial->IsUsedWithLightDiffraction();
		/* END MOD */
	}
};
